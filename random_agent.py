...
class RandomAgent(BaseAgent):
    def __init__(self, id=0, yellow=False, vel_mult=0.3, min_dist_obs=0.3):
    ...
    def decision(self):
        ...
        target_velocity, target_angle_velocity = Navigation.goToPoint(self.robot, self.targets[0], self.min_dist_obs)
